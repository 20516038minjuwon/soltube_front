...
function SearchResults(){
    ...
    if(!q)return <div className={'p-10 text-center'}>검색어를 입력해주세요.</div>
    if(loading)return <div className={'p-10 text-center'}>로딩 중 ..</div>
    return<div className={twMerge(['max-w-400','mx-auto','p-4','sm:p-6'])}>
        <h1 className={'text-xl font-bold mb-6'}>'{q}' 검색결과</h1>
        {videos.length===0
            ?(
